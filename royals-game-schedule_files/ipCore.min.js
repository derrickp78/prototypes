...
b=f[a.toLowerCase()]}
return null==b?null:b},getAllResponseHeaders:function(){return 2===t?e:null},setRequestHeader:function(a,b){var c=a.toLowerCase();return t||(a=s[c]=s[c]||a,r[a]=b),this},overrideMimeType:function(a){return t||(k.mimeType=a),this},statusCode:function(a){var b;if(a)if(2>t)for(b in a)q[b]=[q[b],a[b]];else v.always(a[v.status]);return this},abort:function(a){var b=a||u;return c&&c.abort(b),x(0,b),this}};if(o.promise(v).complete=p.add,v.success=v.done,v.error=v.fail,k.url=((a||k.url||fc)+"").replace(gc,"").replace(lc,ec[1]+"//"),k.type=b.method||b.type||k.method||k.type,k.dataTypes=n.trim(k.dataType||"*").toLowerCase().match(E)||[""],null==k.crossDomain&&(h=mc.exec(k.url.toLowerCase()),k.crossDomain=!(!h||h[1]===ec[1]&&h[2]===ec[2]&&(h[3]||("http:"===h[1]?"80":"443"))===(ec[3]||("http:"===ec[1]?"80":"443")))),k.data&&k.processData&&"string"!=typeof k.data&&(k.data=n.param(k.data,k.traditional)),sc(nc,k,b,v),2===t)return v;i=k.global,i&&0===n.active++&&n.event.trigger("ajaxStart"),k.type=k.type.toUpperCase(),k.hasContent=!kc.test(k.type),d=k.url,k.hasContent||(k.data&&(d=k.url+=(dc.test(d)?"&":"?")+k.data,delete k.data),k.cache===!1&&(k.url=hc.test(d)?d.replace(hc,"$1_="+cc++):d+(dc.test(d)?"&":"?")+"_="+cc++)),k.ifModified&&(n.lastModified[d]&&v.setRequestHeader("If-Modified-Since",n.lastModified[d]),n.etag[d]&&v.setRequestHeader("If-None-Match",n.etag[d])),(k.data&&k.hasContent&&k.contentType!==!1||b.contentType)&&v.setRequestHeader("Content-Type",k.contentType),v.setRequestHeader("Accept",k.dataTypes[0]&&k.accepts[k.dataTypes[0]]?k.accepts[k.dataTypes[0]]+("*"!==k.dataTypes[0]?", "+pc+"; q=0.01":""):k.accepts["*"]);for(j in k.headers)v.setRequestHeader(j,k.headers[j]);if(k.beforeSend&&(k.beforeSend.call(l,v,k)===!1||2===t))return v.abort();u="abort";for(j in{success:1,error:1,complete:1})v[j](k[j]);if(c=sc(oc,k,b,v)){v.readyState=1,i&&m.trigger("ajaxSend",[v,k]),k.async&&k.timeout>0&&(g=setTimeout(function(){v.abort("timeout")},999999));try{t=1,c.send(r,x)}catch(w){if(!(2>t))throw w;x(-1,w)}}else x(-1,"No Transport");function x(a,b,f,h){var j,r,s,u,w,x=b;2!==t&&(t=2,g&&clearTimeout(g),c=void 0,e=h||"",v.readyState=a>0?4:0,j=a>=200&&300>a||304===a,f&&(u=uc(k,v,f)),u=vc(k,u,v,j),j?(k.ifModified&&(w=v.getResponseHeader("Last-Modified"),w&&(n.lastModified[d]=w),w=v.getResponseHeader("etag"),w&&(n.etag[d]=w)),204===a||"HEAD"===k.type?x="nocontent":304===a?x="notmodified":(x=u.state,r=u.data,s=u.error,j=!s)):(s=x,(a||!x)&&(x="error",0>a&&(a=0))),v.status=a,v.statusText=(b||x)+"",j?o.resolveWith(l,[r,x,v]):o.rejectWith(l,[v,x,s]),v.statusCode(q),q=void 0,i&&m.trigger(j?"ajaxSuccess":"ajaxError",[v,k,j?r:s]),p.fireWith(l,[v,x]),i&&(m.trigger("ajaxComplete",[v,k]),--n.active||n.event.trigger("ajaxStop")))}
...
if($('.ipsModuleFormPublic .type-richText').length&&(typeof(ipTinyMceConfigPublic)==="undefined")){$('body').append('<script type="text/javascript" src="'+ipFileUrl('Ip/Internal/Core/assets/js/tiny_mce/jquery.tinymce.min.js')+'"></script>');$('body').append('<script type="text/javascript" src="'+ipFileUrl('Ip/Internal/Core/assets/js/tiny_mce/tinymce.min.js')+'"></script>');$('body').append('<script type="text/javascript" src="'+ipFileUrl('Ip/Internal/Core/assets/tinymce/defaultPublic.js')+'"></script>');}
$('.ipsModuleFormPublic .ipsFileContainer').ipFormFile();$('.ipsModuleFormPublic .type-richText').ipFormRichtext();$('.ipsModuleFormPublic .type-color').ipFormColor();$('.ipsModuleFormAdmin .ipsFileContainer').ipFormFile();$('.ipsModuleFormAdmin .type-richText').ipFormRichtext();$('.ipsModuleFormAdmin .type-color').ipFormColor();$('.ipsModuleFormAdmin .ipsRepositoryFileContainer').ipFormRepositoryFile();$('.ipsModuleFormAdmin .type-url').ipFormUrl();$(document).trigger('ipInitForms');$('.ipsModuleFormPublic, .ipsModuleFormAdmin').each(function(){var $form=$(this);if($form.find(":submit").length==0){$form.append('<input type="submit" style="position: absolute; left: -999999px; width: 1px; height: 1px; visibility: hidden;" tabindex="-1" />');}});$('.ipsModuleFormPublic.ipsAjaxSubmit').validator(validatorConfigPublic);if(typeof(validatorConfigAdmin)!=='undefined'){$('.ipsModuleFormAdmin.ipsAjaxSubmit').validator(validatorConfigAdmin);}
...
var $widget=$(this);var $map=$widget.find('.ipsMap');var data=$map.data();if(!$widget.data('initialized')){if(typeof(data.lat)=='undefined'){data.lat=0;}
 ...
 */
var ipGoogleMapsLoading=false;var ipGoogleMapsLoaded=false;var ipPingInterval;$(document).ready(function(){if($('.ipWidget-Map').length){$(document).on('ipGoogleMapsLoaded',function(){$('.ipWidget-Map').ipWidgetMap();});if(typeof(google)!=='undefined'&&typeof(google.maps)!=='undefined'&&typeof(google.maps.LatLng)!=='undefined'){ipGoogleMapsLoaded();}else{ipLoadGoogleMaps();}}
ipInitForms();ipPingInterval=setInterval(ipPing,1000*60*4);$(document).on('ipContentManagementInit',function(){$(document.body).addClass('ipHasAdminPanel');});$(document).on('ipAdminPanelInit',function(){$(document.body).addClass('ipHasAdminNavbar');});});var ipGoogleMapsLoadedCallback=function(){ipGoogleMapsLoading=false;ipGoogleMapsLoaded=true;$(document).trigger('ipGoogleMapsLoaded');};var ipLoadGoogleMaps=function(){if(ipGoogleMapsLoaded){ipGoogleMapsLoadedCallback();}
if(ipGoogleMapsLoading){return;}
ipGoogleMapsLoading=true;var script=document.createElement('script');script.type='text/javascript';script.src='https://maps.googleapis.com/maps/api/js?key=AIzaSyDEOtKqiFux0f_tpWSRvtcg6L2Guavzor4&v=3.exp&libraries=places&'+'callback=ipGoogleMapsLoadedCallback';document.body.appendChild(script);};var ipPing=function(){$.ajax({url:ip.baseUrl,data:{pa:'Core.ping'},method:'GET'})};